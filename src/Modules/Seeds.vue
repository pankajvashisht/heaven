			...
			<div class="row">
				<div class="col-6">
					<div class="form-group">
						...
						/>
						<div v-show="!editSeeds.name" class="invalid-feedback">
							Name is required
						</div>
					</div>
				</div>
				<div class="col-6">
					<div class="form-group">
						...
						/>
						<div v-show="!editSeeds.church_name" class="invalid-feedback">
				...
				<div class="col-6">
					<div class="form-group">
						...
						/>
						<div v-show="!editSeeds.return_expection" class="invalid-feedback">
				...
				<div class="col-6">
					<div class="form-group">
						...
						/>
						<div v-show="!editSeeds.earth_measure" class="invalid-feedback">
				...
				<div class="col-6">
					<div class="form-group">
						...
						/>
						<div v-show="!editSeeds.heaven_measure" class="invalid-feedback">
				...
				<div class="col-6">
					<div class="form-group">
						...
						/>
						<div v-show="!editSeeds.balance_based_per" class="invalid-feedback">
							Amount is required
						</div>
					</div>
				</div>
		...
		<div class="container animated slideInUp">
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr v-for="(seed, index) in seeds" :key="seed.id">
						<td>{{ seed.name }}</td>
						...
						<td>
							<button class="btn btn-info" @click="editSeed(seed, index)">
								Edit
							</button>
						</td>
					</tr>
