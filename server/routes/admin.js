...
router.get('/seeds/:offset([0-9]+)?/:limit([0-9]+)?', response(admin.seeds));
router.get('/tithe/:offset([0-9]+)?/:limit([0-9]+)?', response(admin.tithe));
router.get('/transaction/:offset([0-9]+)?/:limit([0-9]+)?', response(admin.transaction));
router
