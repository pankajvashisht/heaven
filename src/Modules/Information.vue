<template>
  <div class="animated slideInUp">
    <h3>Infromation</h3>
    <hr />
    <select v-model="id" class="form-control" @change="updates">
      <option v-for="app in appData" :key="app.id" :value="app.id">
        {{ app.key }}
      </option>
    </select>
    <hr />
    ...
    <button
      ...
      @click="updateInfo"
    >
      <i v-show="disabled" class="fa fa-spinner fa-spin" /> Update
    </button>
  </div>
</template>
<script>
